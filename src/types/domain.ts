...
export interface Inspiration extends BaseEntity { title: string; notes: string | null; source_url: string | null; }
export interface FavoriteAsset extends BaseEntity { name: string; category: string | null; notes: string | null; source_url: string | null; }
export interface Asset extends BaseEntity { name: string; category: string; brand: string | null; color: string | null; quantity: number | null; unit: string | null; notes: string | null; }
export interface Work extends BaseEntity { title: string; notes: string | null; completed_at: string | null; }
